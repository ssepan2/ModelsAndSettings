...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        menu_ = New Windows.Forms.MenuStrip()
        ...
        ' menu
        ' 
        menu_.Items.AddRange(New Windows.Forms.ToolStripItem() {menuFile, menuEdit, menuHelp})
        menu_.Location = New Drawing.Point(0, 0)
        menu_.Name = "menu"
        menu_.Size = New Drawing.Size(624, 24)
        menu_.TabIndex = 117
        menu_.Text = "menuStrip1"
        ' 
        ' menuFile
        ' 
